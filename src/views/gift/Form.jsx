	...
	return (
		<form onSubmit={handleSubmit(onSubmit)} className='max-w-[600px] mx-auto'>
			...
			<div className='mt-6 flex items-center justify-center gap-x-6'>
				<button
					type='submit'
					className='rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-common shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>
					Save
				</button>
			</div>
		</form>
