...
const Modal = ({ isOpen, onClose, gender, children }) => {
    ...
    return (
        <div className={`${modalClass} z-50 bg-black bg-opacity-50`}>
            <div className='bg-white p-4 rounded-lg w-[90%] max-w-[500px] relative' ref={modalOverlayRef}>
                <h2 className='text-center font-bold text-lg text-black mb-5'>Add present for your {gender === 'male' ? 'girlfriend' : 'boyfriend'}</h2>
