...
import { Button, Card, CardBody, Checkbox, Image, Link } from '@chakra-ui/react';
...
const Items = ({ data, id, refetch }) => {
	...
	const mutation = useMutation({
		...
		onSuccess: (data) => {
			...
			queryClient.setQueryData(['detail_destination', id], data.data);
							...
							<CardBody className='relative'>
								...
								{item.map_url ? (
									<div className='text-right'>
										<Link href={item.map_url} target='_blank' className='inline-flex items-center !text-blue-600'>
